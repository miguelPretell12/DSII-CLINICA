...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="dashboard">
        ...
        <div class="form-group">
            ...
            <a href="/dashboard/consultas/index" class="btn btn-secondary">Volver</a>
        </div>
                    ...
                    if (e) {
                        ...
                        if (d.length > 0) {
                            d.forEach((consul) => {
                                ...
                                <td>S/. ${precio}</td>
                                <td>
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalconsulta" data-id="${idconsulta}" id="editar"> Editar</button>
